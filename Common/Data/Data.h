...
struct SharedData
{
	...
	double u_front_r[vsize], u_front_l[vsize], u_center_r[vsize], u_center_l[vsize], u_rear_r[vsize], u_rear_l[vsize];
	double v_front_r[vsize], v_front_l[vsize], v_center_r[vsize], v_center_l[vsize], v_rear_r[vsize], v_rear_l[vsize];
	...
	double x_pd, y_pd, vel_pd, closs_pd, closs_y_pd;

	int trigger, collision;
